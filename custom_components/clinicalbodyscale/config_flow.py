"""Config flow to configure the clinicalbodyscale integration."""
...
class ClinicalBodyScaleFlowHandler(ConfigFlow, domain=DOMAIN):
    """Config flow for clinicalbodyscale."""

    VERSION = 4

    def __init__(self) -> None:
        """Initialize ClinicalBodyScaleFlowHandler."""
        super().__init__()
    ...
    ) -> ClinicalBodyScaleOptionsFlowHandler:
        """Get the options flow for this handler."""
        return ClinicalBodyScaleOptionsFlowHandler(config_entry)
    ...
    async def async_step_user(
        ...
        return self.async_step_user_show_form(errors)

    @callback
    def async_step_user_show_form(self, errors: dict[str, str]) -> ConfigFlowResult:
        """Show form for user identity."""
...
class ClinicalBodyScaleOptionsFlowHandler(OptionsFlow):
    """Options flow for clinicalbodyscale."""
